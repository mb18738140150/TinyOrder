...
- (void)createSubView
{
    ...
    self.phoneLabel = [[UILabel alloc] initWithFrame:CGRectMake(_contactLabel.right, _contactLabel.top, (self.width - 2 * LEFT_SPACE) / 2 + LEFT_SPACE, LABEL_HEIGHT)];
    ...
    UIView * lineView = [[UIView alloc] initWithFrame:CGRectMake(0, _phoneLabel.bottom, self.width, 1.5)];
