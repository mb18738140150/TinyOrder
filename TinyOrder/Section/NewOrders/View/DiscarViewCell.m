...
//    self.numberView.arriveTimeLabel.text = dealOrder.hopeTime;
    switch (dealOrder.dealState.intValue) {
        ...
        case 5:
        {
            ...
            [self.totalPriceView.printButton setTitle:@"拒绝退款" forState:UIControlStateNormal];
            [self.totalPriceView.dealButton setTitle:@"同意退款" forState:UIControlStateNormal];
...
//    self.menuView.frame = CGRectMake(0, _discountview.bottom, self.width, _menuView.height);
    ...
    if (dealOrder.dealState.intValue == 4 || dealOrder.dealState.intValue == 6) {
//        self.totalPriceView.hidden = YES;
