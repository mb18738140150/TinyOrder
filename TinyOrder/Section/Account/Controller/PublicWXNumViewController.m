...
@interface PublicWXNumViewController ()
...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"申请入住" style:UIBarButtonItemStyleDone target:self action:@selector(pushAllPublicNumVC:)];
